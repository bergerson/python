...
dir_entrada = '/home/bergerson/Documents/Astronomia/kepler/c13/photometry/k2sc_pdc_plot/med_flux_corrigido/'
dir_saida = '/home/bergerson/Documents/Astronomia/kepler/c13/photometry/k2sc_pdc_plot/graphs_corrigido/'  
...
# load and plot data
	data = np.genfromtxt(dir_entrada+'EPIC_'+name+'_k2sc_correct'+'.csv', delimiter=",", names=["x", "y"])
...
#plt.show()
	...
	savefig(dir_saida+'EPIC_'+name+'_k2sc-corr'+'.pdf')
